...
public class ProfilePostsGateway implements ProfileHandlerInt {
    ...
    public ProfilePostsGateway(Activity activity, RecyclerView recView, View view, User user, Boolean fromHomeProfile) {
    ...
    public void displayView(){
        ...
        adaptor = new ProfilePostsAdaptor(postListContainer,user, fromHomeProfile, spanCount);
