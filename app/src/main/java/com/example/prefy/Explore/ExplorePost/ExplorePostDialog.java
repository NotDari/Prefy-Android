package com.example.prefy.Explore.ExplorePost;
...
public class ExplorePostDialog {
    ...
    public void initVotingSystem(){
        VoteImageHandler.changeImage(fullFeaturedPost.getStandardPost(), postImage, leftCLick, rightClick, "ExploreDialog");
        rightClick.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                VoteImageHandler.voteSubmitted(fullFeaturedPost.getStandardPost(), postImage, leftCLick, rightClick, "rightClick", "ExploreDialog");
            }
        });
        leftCLick.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                VoteImageHandler.voteSubmitted(fullFeaturedPost.getStandardPost(), postImage, leftCLick, rightClick, "leftClick", "ExploreDialog");
            }
        });
    }
